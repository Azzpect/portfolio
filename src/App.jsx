    ...
    <>
      ...
      <section className="intro" id="home">
        ...
        <div className="w-[40%] h-[60%] relative">
          ...
          <h5 className="para leading-10">passionate about problem solving and creating robust applications</h5>
          <div className="btn-container absolute bottom-12">
            <button className="btn bg-[#94DEF5]">See my work</button>
            <button className="btn bg-[#D9D9D9]" onClick={() => {
      ...
      <section id="about" className="container w-[85vw] min-h-[40vh] my-[15vh]">
        <div className="w-[30%]">
          ...
          <p className="para font-regular p-2">I am Atanu Ghosh, a full stack web developer. I am currently pursuing BCA. I live in India, West Bengal, Baruipur. 
I am passionate about problem solving and building full fledged products.
My strengths are my problem solving capability, fast learning, self motivation etc. As for my weakness, I think it is my communication skill which is not good as my other skill but still near average.</p>
        </div>
        <img src='./src/assets/myimage.jpg' className="w-[20%] aspect-square rounded-3xl"/>
      </section>
    </>
  )
}
